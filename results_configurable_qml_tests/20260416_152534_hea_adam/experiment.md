...
|---|---:|---:|---:|---:|---:|---:|
| Adam | 1 | 0.5994 ± 0.0000 | 0.7286 ± 0.0000 | 0.7133 ± 0.0000 | 0.84 ± 0.00 | 2400.0 ± 0.0 |

## Experiment Parameters

```json
{
  "timestamp": "2026-04-16T15:25:34",
  "command": "./run_configurable_qml_test.py --model hea --optimizers adam --loss-function bce --n-qubits 4 --n-layers 3 --max-iterations 1",
  "results_dir": "/Users/maximilianfrohlich/Desktop/GitHub/krotov/results_configurable_qml_tests/20260416_152534_hea_adam",
  "dataset": "two_moons",
  "model_label": "HEA",
  "loss_label": "BCE",
  "args": {
