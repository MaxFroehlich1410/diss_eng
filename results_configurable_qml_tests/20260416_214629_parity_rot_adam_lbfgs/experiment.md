...
|---|---:|---:|---:|---:|---:|---:|
| Adam | 1 | 1.9398 ± 0.0000 | 0.5000 ± 0.0000 | 0.5000 ± 0.0000 | 0.58 ± 0.00 | 500.0 ± 0.0 |
| L-BFGS-B | 1 | 0.0000 ± 0.0000 | 1.0000 ± 0.0000 | 1.0000 ± 0.0000 | 7.85 ± 0.00 | 5792.0 ± 0.0 |

## Experiment Parameters

```json
{
  "timestamp": "2026-04-16T21:46:29",
  "command": "run_configurable_qml_test.py --model parity_rot --dataset parity_4bit --loss-function mse --optimizers adam lbfgs --n-qubits 4 --n-layers 2 --n-samples 4 --max-iterations 2 --seeds 0",
  "results_dir": "/Users/maximilianfrohlich/Desktop/GitHub/krotov/results_configurable_qml_tests/20260416_214629_parity_rot_adam_lbfgs",
  "dataset": "parity_4bit",
